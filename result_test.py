...
test_data_generator = test_generator.flow_from_directory(r'C:\Users\pa662\PycharmProjects\HGM\V11\datasets\test',
                                                        target_size=(64, 64),
                                                        batch_size=10,
...
#Print normalize/unnormalized confusion matrix
con_matrix = confusion_matrix(test_data_generator.classes, predicted_classes)
